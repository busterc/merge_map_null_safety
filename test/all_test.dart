...
void main() {
  ...
  test('can merge two simple maps, including null values', () {
    Map merged = mergeMap([
      {'hello': 'world', 'bye': null},
      {'hello': 'dolly'}
    ], acceptNull: true);
    expect(merged, equals({'bye': null, 'hello': 'dolly'}));
  });

  test('can merge two simple maps, excluding null values', () {
    Map merged = mergeMap([
      {'hello': 'world', 'bye': null},
      {'hello': 'dolly'}
    ]);
    expect(merged, equals({'hello': 'dolly'}));
  });
